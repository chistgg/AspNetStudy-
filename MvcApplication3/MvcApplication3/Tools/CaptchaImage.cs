...
namespace MvcApplication3.Tools
{
    ...
    {
        public const string CAPTCHA_VALUE_KEY = "CaptchaImageText";
        ...
        private void GenerateImage()
        {
            ...
            //Fill in the backgroung
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.SmallConfetti, Color.LightBlue, Color.LightCoral );

...
namespace MvcApplication3.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IRepositoryRole>().To<SqlRepository>().InRequestScope();
            kernel.Bind<IRepositoryUser>().To<SqlRepository>().InRequestScope();
            kernel.Bind<MvcApplication3.Mappers.IMapper>().To<MvcApplication3.Mappers.CommonMapper>().InSingletonScope();
        }        
    }
}
